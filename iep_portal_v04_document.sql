...
--
-- Host: localhost
-- Generation Time: Apr 20, 2022 at 12:06 AM
...
CREATE TABLE `document` (
  ...
  `document_path` varchar(150) COLLATE utf8mb4_general_ci NOT NULL
...
(1, 1, 'Goal Name', 'Communication/Language', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1),
(2, 1, 'Goal Name', 'Social/Emotional', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1),
(3, 2, 'Goal Name', 'Academic/Reading', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1),
(4, 3, 'Goal Name', 'Independent Functioning', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1),
(5, 3, 'Goal Name', 'Social/Emotional', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1),
(6, 4, 'Goal Name', 'Communication/Language', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1),
(7, 4, 'Goal Name', 'Academic/Writing', 'Here is a brief description of the goal, as it would be described on the IEP plan agreed on by parents and school.', 1);
...
(1, 1, 'Objective Name', 'A brief text description of the objective, what is measured over how many attempts.', 10, 7, 0),
...
(4, 2, 'Objective Name', 'A brief text description of the objective, what is measured over how many attempts.', 10, 7, 0),
...
CREATE TABLE `user` (
  ...
  `user_password` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `user_email` varchar(65) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_phone` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_city` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_district` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `objective`
  MODIFY `objective_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
